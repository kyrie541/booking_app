...
var badminton_court_drop_down_list_full_HTML_text="<label for='courtNum'>Court Number: </label><select name='courtNum' class='court_number_drop_down_list'>" +badminton_court_option +"</select><span class='solo_show_price'> Price : RM </span>";
var futsal_court_drop_down_list_full_HTML_text="<label for='courtNum'>Court Number: </label><select name='courtNum' class='court_number_drop_down_list'>" +futsal_court_option +"</select><span class='solo_show_price'> Price : RM </span>";
